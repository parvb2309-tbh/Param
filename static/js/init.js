// Param UI — Initialization Scripts
...
function markComposerUserEdited() {
  ...
  msgInput.addEventListener('input', () => {
    window.__paramComposerUserEdited = !!msgInput.value;
  });
}
...
function clearFreshComposerRestore() {
  ...
  if (window.__paramComposerUserEdited || document.activeElement === msgInput) return;
  if (msgInput.value) {
    msgInput.value = '';
