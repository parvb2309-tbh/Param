...
```text
[order-report] working directory: /path/to/param
...
[order-report] reproduce with: /path/to/param/venv/bin/python /path/to/param/tests/run_order_report.py --seed 284734921 -- tests/cli/ -q
```
