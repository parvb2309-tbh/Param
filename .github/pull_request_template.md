...
- [ ] I searched [open issues](https://github.com/param-dev/param/issues) and [open PRs](https://github.com/param-dev/param/pulls) — this is not a duplicate.
- [ ] This PR targets `dev`
...
- [ ] **Style match**: the change uses Param's existing visual language. Specifically:
