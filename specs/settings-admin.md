...
- CLI helpers `scripts/param-preset` and `scripts/param-theme`.
...
`scripts/param-preset` is a local CLI for preset store maintenance and backup of `presets.json`.
