...
const LS_KEY = 'param-theme';
const CUSTOM_THEMES_KEY = 'param-custom-themes';
...
const ADV_KEYS = [
  ...
  { key: 'brandColor',         css: '--brand-color',       label: 'परम Logo',    group: 'Sidebar' },
...
const UI_SCALE_KEY = 'param-ui-scale';
...
export function initThemeUI() {
  ...
  if (exportBtnEl) {
    ...
    newExp.addEventListener('click', () => {
      ...
      a.href = url;
      a.download = 'param_' + (obj.name || 'theme') + '.json';
      a.click();
