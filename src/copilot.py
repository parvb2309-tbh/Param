...
COPILOT_USER_AGENT = os.environ.get(
    "PARAM_COPILOT_USER_AGENT", "Param/1.0"
)
COPILOT_INTEGRATION_ID = os.environ.get(
    "PARAM_COPILOT_INTEGRATION_ID", "vscode-chat"
)
COPILOT_EDITOR_VERSION = os.environ.get(
    "PARAM_COPILOT_EDITOR_VERSION", "Param/1.0"
)
