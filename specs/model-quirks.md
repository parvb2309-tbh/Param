...
Param code, tests, Issues, PRs, commits, and provider documentation. It is a
...
- GPT-OSS deployments can reserve native tool names. Runtime aliases colliding Param tool names at the provider boundary and reverses the alias before local execution; this is dialect compatibility, not extra tool authorization.
