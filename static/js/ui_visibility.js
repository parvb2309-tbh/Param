...
// under `param-ui-visibility` (loaded/saved by app.js).
//
...
export const UI_VIS_DEFAULT_OFF = new Set(['rag-toggle-btn', 'text-emojis', 'chat-fullwidth', 'tool-cookbook', 'tool-gallery', 'email-section']);
