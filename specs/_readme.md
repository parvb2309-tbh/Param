...
This folder is the compact implementation-truth map for humans and coding agents working on Param. Read this file first, then open only the subsystem specs that match the work.
...
- Use repo source and these specs as the authority for Param architecture. Do not treat global skill registries or external agent metadata as repo ground truth.
