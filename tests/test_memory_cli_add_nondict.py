"""cmd_add (scripts/param-memory) must tolerate a non-dict row in the
...
def _load_cli(monkeypatch):
    ...
    path = ROOT / "scripts" / "param-memory"
    loader = importlib.machinery.SourceFileLoader("param_memory_cli_add", str(path))
