...
const EMAIL_DOC_SPLIT_WIDTH_KEY = 'param-email-doc-split-width';
const EDGE_DOCK_WIDTH_KEY_PREFIX = 'param-edge-dock-width';
...
(function _initEdgeDockResizeHandles() {
  ...
  window.addEventListener('param:modal-opened', _positionEdgeDockResizeHandles);
  _positionEdgeDockResizeHandles();
})();
