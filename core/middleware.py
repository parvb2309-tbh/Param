...
INTERNAL_TOOL_TOKEN = os.environ.get("PARAM_INTERNAL_TOKEN") or secrets.token_hex(32)
INTERNAL_TOOL_HEADER = "X-Param-Internal-Token"
...
def require_admin(request: Request):
    ...
    # (a) header-direct (caller set X-Param-Internal-Token), or
