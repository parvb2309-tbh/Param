#!/usr/bin/env python3
"""Create/remove the switchable 'Demo' EmailAccount in Param.

Mirrors the existing local-Dovecot account (localhost:31143, STARTTLS) but points
at the throwaway demo@param.local mailbox. Password is stored Fernet-encrypted
