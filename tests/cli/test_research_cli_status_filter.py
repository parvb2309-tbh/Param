"""`param-research list --status complete` was returning nothing.
...
Part of #2122 (param-* CLI list/search bugs).
"""
...
def _load_cli():
    path = ROOT / "scripts" / "param-research"
    loader = importlib.machinery.SourceFileLoader("param_research_cli", str(path))
