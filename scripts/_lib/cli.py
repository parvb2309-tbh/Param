"""scripts/_lib/cli.py — shared scaffolding for the `param-*` CLIs.
...
parents-parser pattern. Usage:
    ...
    def build_parser():
        p = common_parser("param-foo", "Description.")
...
# Make repo root importable. Tools are invoked as `scripts/param-foo`
...
VERSION = "0.1.0"  # bumped centrally; every param-* CLI reports this
