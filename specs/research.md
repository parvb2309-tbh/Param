...
- research CLI access in `scripts/param-research`;
...
- Decide whether direct JSON access by `manage_research` and `scripts/param-research` must be owner-filtered like browser routes or is local/tool-only.
