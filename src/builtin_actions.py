...
async def action_run_script(owner: str, script: str = "", host: str = "", **kwargs) -> Tuple[str, bool]:
    ...
    target_host = (host or os.getenv("PARAM_SCRIPT_HOST", "localhost")).strip()
                    ...
                    for uid_b in uids:
                        ...
                        try:
                            ...
                            if not raw:
                                ...
                                continue
                            msg = _email_mod.message_from_bytes(raw)
                            # Skip Param-generated reminders so the scanner
                            ...
                            _ody_origin = (msg.get("X-Param-Origin") or "").strip().lower()
                            _ody_kind = (msg.get("X-Param-Kind") or "").strip().lower()
                            ...
                            if (_ody_origin == "param-ui" or _ody_kind == "reminder"
                                    or _raw_subj.startswith("reminder (param):")
...
BUILTIN_ACTION_INFO = {
    ...
    "run_script": "Run a script locally or on PARAM_SCRIPT_HOST",
